...
CONFIG = {
    ...
    "INPUT_EXCEL_PATH": "r_and_d_tasks.xlsx",
    "OUTPUT_FOLDER": "02_Data_Imports",

    # Excel Column Mapping (Key: Internal Variable, Value: Excel Header String)
    "COL_ID": "ID",                 # The unique ID column (Column A)
    "COL_PRODUCT": "Product",       # e.g., Q6
    "COL_PHASE": "Phase",           # e.g., FPGA, Design
    "COL_TASK": "Task Name",        # The main task name
    "COL_PREDECESSORS": "Predecessors", # Dependency IDs (e.g., "18, 31")
    "COL_SEQUENCE": "Sequence",     # Developer execution order/priority
    "COL_OWNER": "Owner",           # Task assignees
    "COL_STATUS": "Status",         # Completion status
    "COL_PLAN_START": "Plan Start",
    "COL_PLAN_END": "Plan End",
    "COL_ACTUAL_START": "Actual Start",
    "COL_ACTUAL_END": "Actual End",
