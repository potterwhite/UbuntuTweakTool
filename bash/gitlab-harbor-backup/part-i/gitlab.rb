...
external_url 'http://192.168.3.67'
git_data_dirs({
  "default" => {
    "path" => "/development/a-gitlab/gitlab2025/gitlab-data/"  # 改为您想存储仓库的路径
  }
})
...
gitlab_rails['lfs_enabled'] = true
gitlab_rails['lfs_storage_path'] = "/development/a-gitlab/gitlab2025/git-lfs-objects"
