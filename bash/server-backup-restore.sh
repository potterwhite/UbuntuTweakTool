...
1_0_setup_env(){
	...
	BACKUP_DIR="/mnt/development/backup"
	HARBOR_DIR="/mnt/development/harbor2025/harbor"
	HARBOR_DATA="/mnt/development/harbor2025/data"
}
...
restore() {
  echo "开始恢复 GitLab..."
  cp "$BACKUP_DIR/gitlab_backup.tar" /var/opt/gitlab/backups/
